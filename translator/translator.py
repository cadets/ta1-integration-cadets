...
#         properties["host2Uuid"] = cadets_record["host2"]
    ...
    def translate_host_info(self, cadets_record):
        ...
        if not ig.is_known_object(cadets_record["host"]):
            datums.append(ig.create_host_object(cadets_record["host"], self.host_type, cadets_record["hostname"], cadets_record["uname"], cadets_record["network"], cadets_record.get("version","")))
